...
export const spanish: Record<string, string> = {
  ...
  "Get a quote": "Cotiza tu idea",
  "What could we": "¿Qué podemos",
  "make for you?": "crear para ti?",
  "START A PROJECT": "COMIENZA UN PROYECTO",
  "Every good thing": "Todo lo bueno",
  "starts with an idea.": "comienza con una idea.",
  "Tell us what you have in mind. We’ll shape the scope around your business.": "Cuéntanos qué tienes en mente. Definiremos el alcance según tu negocio.",
  "Prefer a conversation?": "¿Prefieres conversar?",
  "Project inquiry": "Consulta de proyecto",
  "A little about you": "Un poco sobre ti",
  "Your business & your idea": "Tu negocio y tu idea",
  "Your name": "Tu nombre",
  "Email address": "Correo electrónico",
  "Phone (optional)": "Teléfono (opcional)",
  "Business name": "Nombre del negocio",
  "Website or social link (optional)": "Sitio web o red social (opcional)",
  "Desired timing (optional)": "Fecha deseada (opcional)",
  "Tell us about your idea": "Cuéntanos sobre tu idea",
  "What do you do, what would you like to create, and what should it help your business achieve?": "¿A qué te dedicas, qué te gustaría crear y cómo debería ayudar a tu negocio?",
  "A date, a season, or still exploring": "Una fecha, una temporada o todavía explorando",
  "This form prepares an email draft. Your details are not submitted or saved to a database by this page.": "Este formulario prepara un borrador de correo. Esta página no envía tus datos ni los guarda en una base de datos.",
  "Prepare my inquiry": "Preparar mi consulta",
  "Save a copy instead": "Guardar una copia",
  "Review the draft in your email app and send it when you’re ready.": "Revisa el borrador en tu aplicación de correo y envíalo cuando estés listo.",
  "Your inquiry is ready to save. Nothing has been sent.": "Tu consulta está lista para guardar. No se ha enviado nada.",
  "Your email app will open a draft. Review and send it there. You can also save your inquiry and email it to Jose.": "Se abrirá un borrador en tu aplicación de correo. Revísalo y envíalo desde allí. También puedes guardar tu consulta y enviársela a Jose.",
